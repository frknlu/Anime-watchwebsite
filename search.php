...
<head>
	...
	<title>Anime Arama - <?php echo $setting["title"];?></title>
...
if(empty($_GET['V']))
{
	$bulunamadi2='<font color="red"><center>Herhangi bir sonuç bulunamadı...</center></font>';
}
else{
	
	$turislem=mysqli_query($con,"select * from manga where ad LIKE '%$animeadi%'");
}
                                ...
                                <div class="entry-header">
                                    <div class="entry-header_wrap">
                                        <div class="entry-title">
                                            <h2 class="item-title">Bulunan Sonuçlar</h2>
                                        </div>
                                    </div>
                                </div>
...
<img data-src="uploads/'.$turgoster["kapak_resim"].'" class="img-responsive effect-fade lazyloaded" src="uploads/'.$turgoster["kapak_resim"].'" style="padding-top:150px;width:110px;height:150px" alt="wallhaven-550618">
</a>
</div>
